...
app.controller("EmployeeController", function($scope, $http) {
    ...
    $scope.editEmployee = function(employee) {
        ...
        $scope.employeeForm.empSurname = employee.empSurname;
        $scope.employeeForm.position = employee.position;
        $scope.employeeForm.priority = employee.priority;
    };
    ...
    function _clearFormData() {
        ...
        $scope.employeeForm.empSurname = "";
        $scope.employeeForm.position = "";
        $scope.employeeForm.priority = "";
    };
});